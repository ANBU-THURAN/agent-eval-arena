...
import { AgentTools, ToolResult } from './AgentTools.js';
...
interface GetAgentStatesArgs {
  // No arguments
}

type ToolArgs = MakeProposalArgs | AcceptProposalArgs | RejectProposalArgs | CounterProposalArgs | GetAgentStatesArgs;
...
export class AgentExecutionEngine {
  ...
  private readonly minApiCallDelay: number;

  constructor(minDelayMs: number = DEFAULT_RATE_LIMIT_MS) {
